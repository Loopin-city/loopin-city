        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-8">
          <div className="flex flex-col items-start gap-3 md:gap-4">
            ...
            <div className="flex space-x-4 mt-2">
              <a href="https://www.linkedin.com/company/city-loopin/?viewAsMember=true" className="text-accent-black hover:text-accent-white hover:bg-accent-black p-1 rounded transition-colors duration-200">
