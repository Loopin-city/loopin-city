...
ALTER TABLE admin_community_duplicates 
...
CREATE INDEX IF NOT EXISTS idx_communities_website ON communities(website);
CREATE INDEX IF NOT EXISTS idx_communities_verification_city ON communities(verification_status, city_id);
